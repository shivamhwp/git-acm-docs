...
### 2.0.0-rc1 and 2.0.0-rc2
    ...
    - Pre-release with OpenRouter integration.
    - New workflow: `get-models`, `list`, `use <model_id>`.
    - Stores `git-acm-prefs.json` and `models.json` in OS config dirs.
    - Installer improvements; re-run install to update.
